...
const projects: Array<ProjectProps> = [
  ...
  },
  {
    ...
    img: '/portfolio-react/markdown.avif',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/car-factory.jpeg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/weather-dashboard.jpg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/employee-tracker.jpeg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/github-search.png',
    description:
  ...
  {
    title: 'Kanban Board',
    img: '/portfolio-react/kanban-board.png',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/express-mongo.jpeg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/book-search-engine.jpg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/cypress.png',
    description:
  ...
  {
    title: 'CI/CD',
    img: '/portfolio-react/github-actions.jpg',
    description:
  ...
  },
  {
    ...
    img: '/portfolio-react/python.jpg',
    description:
  ...
  return (
    <div className="card-container">
      {projects.map((project, i) => (
        <m.div key={project.title} initial={{opacity: 0, y: '100%'}} animate={{opacity: 1, y: 0}}
               transition={{duration: 0.45 * i, ease: 'easeOut'}} exit={{opacity: 0}}>
          <m.div whileHover={{scale: 1.1}} transition={{duration: 0.45, ease: 'easeOut'}}>
            <Project title={project.title} img={new URL(project.img, import.meta.url).href} gitHub={project.gitHub} type={project.type}
                     deployment={project.deployment} description={project.description}/>
          </m.div>
        </m.div>
      ))}
    </div>
